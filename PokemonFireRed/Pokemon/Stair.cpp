...
void AStair::RegisterPredefinedEvent()
{
	...
	UEventManager::RegisterEvent(this, StairCond,
		ES::Start(true)
		>> ES::FadeOut(0.5f)
		>> ES::MoveWithoutRestriction(GetWorld()->GetName(), Global::Player, FirstPath, 0.75f * Global::CharacterWalkSpeed)
		...
		>> ES::FadeIn(0.5f)
		>> ES::MoveWithoutRestriction(TargetMapName, Global::Player, SecondPath, 0.75f * Global::CharacterWalkSpeed)
