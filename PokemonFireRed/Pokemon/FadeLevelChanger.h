...
public:
	...
	void Trigger(std::string_view _TargetLevelName, bool _PlayerControl, float _FadeInTime, float _FadeOutTime)
	{
		Update(_TargetLevelName, _PlayerControl, _FadeInTime, _FadeOutTime);
...
private:
	...
	void Update(std::string_view _Name, bool _PlayerControl, float _FadeInTime, float _FadeOutTime);
